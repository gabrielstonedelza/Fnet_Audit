...
class AddCompanyAmountPayment(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        save_screenshot(self.screenshot1)
        save_screenshot(self.screenshot2)
        save_screenshot(self.screenshot3)
        save_screenshot(self.screenshot4)
        save_screenshot(self.screenshot5)
        save_screenshot(self.screenshot6)
        save_screenshot(self.screenshot7)
        save_screenshot(self.screenshot8)
        save_screenshot(self.screenshot9)
        save_screenshot(self.screenshot10)
        save_screenshot(self.screenshot11)
        save_screenshot(self.screenshot12)
        save_screenshot(self.screenshot13)
        save_screenshot(self.screenshot14)
        save_screenshot(self.screenshot15)
        save_screenshot(self.screenshot16)
        save_screenshot(self.screenshot17)
        save_screenshot(self.screenshot18)
        save_screenshot(self.screenshot19)
        save_screenshot(self.screenshot20)


def save_screenshot(de_image):
    img = Image.open(de_image.path)
    if img.height > 300 or img.width > 300:
        output_size = (300, 300)
        img.thumbnail(output_size)
        img.save(de_image.path)
