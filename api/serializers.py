...
class CompanySerializer(serializers.ModelSerializer):
    class Meta:
        model = Company
        fields = ['id','agent','bank','name','phone','account_number','date_created','get_agent_username','created_month','created_year']
...
class AddCompanyAmountPaymentSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','agent','company','amount','screenshot','unique_identifier','date_paid','get_agent_username','get_screenshot_pic','get_company_amount_received','get_amount_received_receipt','get_amount_received_date','get_company_name','get_account_number','payment_month','payment_year']
        read_only_fields = ['agent']
